        ...
        <main className={styles.my_links} style={selectedTab === 0 ? {height: '100vh'} : {height: 'auto'}}>
           <div className={styles.my_links_container}>
                <div className={styles.fixed_section}>
                    <div className={styles.title_img} style={{backgroundImage: `url("${me.src}")`}}></div>
                    <h1 className={styles.instagram_title}>@_muller.dev</h1>
                    <p className={styles.description}>👨‍💻 Atuando desde 2019</p>
                    <p className={styles.description}>❤️ Apaixonado por tecnologia</p>
                    <p className={styles.description}>🚀 Desenvolvedor Fullstack</p>
